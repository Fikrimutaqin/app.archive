...
<div class="content-page">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="<?php echo BASEURL; ?>/dashboard" type="button" class="btn btn-primary my-3">
        ...
        <div class="row mt-3">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="<?php echo BASEURL; ?>/document/updateMe" enctype="multipart/form-data">
