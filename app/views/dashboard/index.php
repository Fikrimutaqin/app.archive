...
<div class="content-page">
    ...
    <div class=" container-fluid">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card card-block card-stretch card-height iq-welcome" style="background: url(<?php echo BASEURL; ?>/assets/images/layouts/mydrive/background.png) no-repeat scroll right center; background-color: #ffffff; background-size: contain;">
                    <div class="card-body property2-content">
                        <div class="d-flex flex-wrap align-items-center">
                            <div class="col-lg-6 col-sm-6 p-0">
                                <h3 class="mb-3">Selamat Datang <?php echo $_SESSION['first_name']; ?></h3>
                                <p class="mb-5">Mau Arsip Dokumen Apa Hari ini?</p>
                                <a href="#" data-toggle="modal" data-target="#uploadnewdokumen">Upload Dokumen <i class="fa fa-arrow-right ml-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-block card-stretch card-transparent mt-3">
                    <div class="card-header d-flex justify-content-between pb-0">
                        ...
                        <div class="card-header-toolbar d-flex align-items-center">
                            <a href="<?php echo BASEURL; ?>/document/viewallMe" class=" view-more">Lihat Semua</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="card-header-toolbar">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton2">
                                                <a class="dropdown-item" href="<?php echo BASEURL; ?>/document/deleteMe/<?= $items['no_dok'] ?>" onclick="return confirm('Are Sure Delete This Data?');">
                                                    <i class="fa fa-trash mr-2"></i>
                                                    Delete
                                                </a>
                                                <a class="dropdown-item" href="<?php echo BASEURL; ?>/document/editDokMe/<?= $items['no_dok'] ?>">
                                ...
                                <a href="<?php echo BASEURL; ?>/document/viewDokMe/<?= $items['no_dok'] ?>" class="folder">
                                    ...
                                    <p class="mb-2">
                                        ...
                                        <?php echo date('d F Y', strtotime($items['tanggal_upload'])); ?>
                                    </p>
                                    <p class="mb-0">
                                        <i class="las la-file-alt text-danger mr-2 font-size-20"></i>
                                        <?php
                                        $size = $items['ukuran_file'];
